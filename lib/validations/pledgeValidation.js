...
var luhnCheck = require('../utils/luhnCheck');
...
var pledge = new Checkit({
  ...
  amount: [{
    rule: 'required',
    message: 'You must supply the dollar amount you want to put towards the project. Do not include a $ sign.'
  }, {
    rule: 'numeric',
    message: 'You must enter a number for the amount of your pledge. Do not include a $ sign.'
  }, {
    rule: 'greaterThan:0',
    message: 'You must enter a number greater than 0 for the amount of your pledge. Do not include a $ sign.'
  }],
  projectId: [{
    rule: 'required',
