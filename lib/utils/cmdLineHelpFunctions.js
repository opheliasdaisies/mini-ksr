...
function projectHelp(argv) {
  argv.usage('Usage: $0 project <projectName> <targetAmount>')
    .help('h')
...
function backHelp(argv) {
  argv.usage('Usage: $0 back <backerName> <projectName> <creditCard> <pledgeAmount>')
    .help('h')
...
function listHelp(argv) {
  argv.usage('Usage: $0 list <projectName>')
    .help('h')
...
function backerHelp(argv) {
  argv.usage('Usage: $0 backer <backerName>')
    .help('h')
